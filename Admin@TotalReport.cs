...
{
    public partial class Admin_TotalReport : Form
    {
        ...
        public Admin_TotalReport()
        {
            InitializeComponent();
        }
        private void Admin_TotalReport_Load(object sender, EventArgs e)
        {
            conn.Open();
        ...
        private void Admin_TotalReport_FormClosing(object sender, FormClosingEventArgs e)
        {
